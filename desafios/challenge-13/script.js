(function (params) {
    ...
    */
    var sul = ['Santa Catarina', 'Rio gran do sul', 'Paraná'];
    var sudeste = ['Esprito Santo', 'Minas Gerais', "São Paudo"];
    ...
    */
    ...
    brasil.unshift('Pará', 'Acre', 'Amazonas');
    console.log(brasil);
    ...
    */
    var nordeste = ['alagoas', 'Bahia', 'Maranhão', 'pernabunco'];
