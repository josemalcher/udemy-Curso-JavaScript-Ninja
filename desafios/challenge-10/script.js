(function () {
    ...
    */
    ...
    - Primeiro, crie um objcd eto chamado `operation` que terá as propriedades:
    '+', '-', '*', '/' e '%'.
    ...
    */
    function isOperatorValid(operator) {
        ...
        return !!operation[operator]; //retorna o equivalente booleano
    }
    console.log(isOperatorValid('+'));
    console.log(isOperatorValid('g'));
    ...
    */
    if (sum) {
        num1 = 10;
        num2 = 12;
        console.log(showErrorMessage(operationSignal, num1, num2), sum(num1, num2));
    } else {
    ...
    */
    ...
    if (sum) {
        num1 = 20;
        num2 = 10;
        console.log(showErrorMessage(operationSignal, num1, num2), subtraction(num1, num2));
    } else {
        console.log(showOperationMessage(operationSignal));
    }
    ...
    if (sum) {
        num1 = 20;
        num2 = 10;
        console.log(showErrorMessage(operationSignal, num1, num2), multiplicacao(num1, num2));
    } else {
        console.log(showOperationMessage(operationSignal));
    }
    ...
    if (sum) {
        num1 = 20;
        num2 = 10;
        console.log(showErrorMessage(operationSignal, num1, num2), divi(num1, num2));
    } else {
        console.log(showOperationMessage(operationSignal));
    }
    ...
    if (sum) {
        num1 = 20;
        num2 = 10;
        console.log(showErrorMessage(operationSignal, num1, num2), modulo(num1, num2));
    } else {
        console.log(showOperationMessage(operationSignal));
    }
    ...
    */
    ...
    if (sum) {
        num1 = 20;
        num2 = 10;
        console.log(showErrorMessage(operationSignal, num1, num2), invalido(num1, num2));
    } else {
        console.log(showOperationMessage(operationSignal));
    }
